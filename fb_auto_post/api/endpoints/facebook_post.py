...
async def create_photo_story(request: PostPhotoStoryRequest):
    ...
    # remove file after all attempts
    ...
    if unpublished_pages:
        ...
        return BasicResponse(status="error", msg=final_error_msg)
    else:
        # All pages succeeded (eventually)
        logger.info("Photo story posted successfully to all pages.")
        return BasicResponse(status="success", msg="Story posted successfully to all pages")
...
async def create_video_story(request: PostVideoStoryRequest):
    ...
    try:
        ...
        # remove file after all attempts or on error
        force_remove(request.video)
        return PostContentResponse(page_responses=page_responses)
...
async def create_video(request: PostVideoRequest):
    ...
    try:
        ...
        if unpublished_pages:
            ...
            return BasicResponse(status="success", msg="Video posted successfully to all pages")
